        ...
        try {
            ...
            try {
                ...
                if (message.includes("ya está registrado")) {
                    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiLogin"])(ownerEmail, ownerPassword);
                    userId = user.id;
                } else {
                    throw err;
                }
